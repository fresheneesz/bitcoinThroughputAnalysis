...
def info(year):
	...
	print("%s  \t   %5u GB \t\t\t%.02fx \t\t\t%.02fx" % (year, cur_blockchain_size, sync_time_a, sync_time_b)) 

print("Year \tBlockchain size \tSync time vs "+str(start_year)+" \tSync time vs "+str(target[0]))
